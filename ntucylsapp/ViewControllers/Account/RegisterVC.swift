...
class RegisterVC: UIViewController, UITextFieldDelegate {
    ...
    override func viewDidLoad() {
        ...
        TextfieldSetup.defaultType(textfield: accountTextfield, view: view, placeholder: "Account ID")
        TextfieldSetup.defaultType(textfield: passwordTextfield, view: view, placeholder: "Password")
    ...
    @objc func sendTouch(_sender: UIButton){
        if accountTextfield.text != "" && passwordTextfield.text != ""{
            if accountTextfield.text!.count != 9{
                ...
                Alerts.defaultAlert(title: "請詳閱說明和服務條款", message: "Please read the instruction.", UIvc: self)
            }else{
                ...
                Auth.auth().createUser(withEmail: email, password: password) { (result, error) in
                    ...
                    let init_profile = ["name":"",
                                        "grade":"",
                                        "count":"",
                                        "epoch":"",
                                        "home":"",
                                        "group":""]
                    db.collection("profile").document(self.accountTextfield.text!.lowercased()).setData(init_profile, merge: true)
    ...
    @objc func checkBoxIsTouched(_sender: UIButton){
        if !check.checkbool{
            let alert = UIAlertController(title: "服務條款\nTerms of Service", message: termsOfService, preferredStyle: .alert)
            ...
            alert.addAction(UIAlertAction(title: "Not Agree", style: .cancel, handler: nil))
            self.present(alert, animated: true, completion: nil)
        }else{
    ...
    func textViewSetup(textview: UITextView){
        ...
        textview.text =
        """
        請詳閱使用說明及服務條款（點擊打勾處可查看服務條款）：\n
        Please read the instruction (touch the checkbox to see the terms of service)\n
        (English below)\n
        注意事項：\n
...
These Terms of Use constitute a legally binding agreement made between you, whether personally or on behalf of an entity (“you”) and NTUCYLS ("Company", “we”, “us”, or “our”), concerning your access to and use of the https://www.facebook.com/ntucyls website as well as any other media form, media channel, mobile website or mobile application related, linked, or otherwise connected thereto (collectively, the “Site”). You agree that by accessing the Site, you have read, understood, and agreed to be bound by all of these Terms of Use. IF YOU DO NOT AGREE WITH ALL OF THESE TERMS OF USE, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SITE AND YOU MUST DISCONTINUE USE IMMEDIATELY.
...
These Terms shall be governed by and defined following the laws of Taiwan. NTUCYLS and yourself irrevocably consent that the courts of Taiwan shall have exclusive jurisdiction to resolve any dispute which may arise in connection with these terms.
...
Any dispute arising out of or in connection with this contract, including any question regarding its existence, validity, or termination, shall be referred to and finally resolved by the International Commercial Arbitration Court under the European Arbitration Chamber (Belgium, Brussels, Avenue Louise, 146) according to the Rules of this ICAC, which, as a result of referring to it, is considered as the part of this clause. The number of arbitrators shall be three (3). The seat, or legal place, of arbitration shall be Taipei, Taiwan. The language of the proceedings shall be Mandarin. The governing law of the contract shall be the substantive law of Taiwan.
